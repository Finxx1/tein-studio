...
GLOBAL constexpr const char* KB_RUN_FOCUSED_MOD      = "run_focused_mod";
GLOBAL constexpr const char* KB_FOCUS_PREV_MOD       = "focus_prev_mod";
GLOBAL constexpr const char* KB_FOCUS_NEXT_MOD       = "focus_next_mod";
GLOBAL constexpr const char* KB_MODS_LIST            = "mods_list";
